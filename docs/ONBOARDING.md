...
**PAL User Layer - Technical Onboarding Guide**
...
**Instructions:** Reference this guide when you encounter unfamiliar technical concepts. Framework Master will link here when relevant.
...
- **Layer**: USER
- **Priority**: 7 (loaded after CONTACTS - educational reference)
- **Dependencies**: None (standalone educational guide)

### Target Location
```
[PROJECT_ROOT]/PAL_Base/User/ONBOARDING.md
```
...
1. **Verify Directory Structure**
   ```bash
   mkdir -p PAL_Base/User
   ```

2. **Place File**
   - Copy this file to `PAL_Base/User/ONBOARDING.md`
...
3. **Register in SessionStart Hook**
   ...
   const userFiles = [
     'PAL_Base/User/ABOUTME.md',       // Priority: 1
     'PAL_Base/User/DIRECTIVES.md',    // Priority: 2
     'PAL_Base/User/TECHSTACK.md',     // Priority: 3
     'PAL_Base/User/TERMINOLOGY.md',   // Priority: 4
     'PAL_Base/User/DIGITALASSETS.md', // Priority: 5
     'PAL_Base/User/CONTACTS.md',      // Priority: 6
     'PAL_Base/User/ONBOARDING.md',    // Priority: 7
     // ... other USER files
   ];
   ```
...
4. **Validate Integration**
   ...
   - Ask: "Explain how Git works"
   - Verify PAL references this guide appropriately

### How This File Is Used

| System Component | Usage |
|------------------|-------|
| **PAL Master** | Links to relevant sections when explaining concepts |
| **User Learning** | Reference for technical concepts |
| **Troubleshooting** | Common errors and solutions |
| **Context** | Helps PAL calibrate explanations to user's level |

### Customization Required

This file is pre-filled with common concepts. Optionally customize:

- [ ] **Foundations** - Add/remove based on your familiarity
- [ ] **Package Management** - Focus on your preferred tools
- [ ] **Deployment** - Add your specific deployment patterns
- [ ] **Troubleshooting** - Add common errors you encounter
- [ ] **Glossary** - Add project-specific terms

### First-Use Checklist
- [ ] File placed in `PAL_Base/User/`
- [ ] SessionStart hook loads file at priority 7
- [ ] Review content matches your technical level
- [ ] PAL references guide when explaining concepts

---

**Document Version:** 1.0.0
**Last Updated:** 2026-01-14
**Related Files:** TECHSTACK.md, TERMINOLOGY.md
