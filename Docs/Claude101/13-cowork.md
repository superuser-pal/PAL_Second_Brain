---
title: "13 - Claude Cowork: Agentic Desktop"
...
# 13 — Claude Cowork: Agentic Desktop
...
| ---------------- | --------------------- | ----------------- | ----------- |
| **User**         | Second brain builders | Knowledge workers | Everyone    |
...
- **File Organization** — Messy folders into organized structure
- **Expense Tracking** — Receipts into Excel reports
- **Report Synthesis** — Multiple docs into unified report
- **Meeting Prep** — Research into briefing documents
...
Cowork and PAL serve complementary audiences:

- **Cowork** is for non-technical users who want file organization and document generation via the Claude Desktop app
- **PAL** is for users who want structured AI context management via Claude Code (CLI/IDE)

If you're a non-developer exploring PAL, Cowork may be a gentler entry point. PAL's Obsidian integration provides a similar non-technical interface for reading and navigating your second brain.
