...
Unlike the general PAL Master, the Life Coach has all seven of those life files loaded into its "working memory" at all times. It doesn't just know your name; it knows your mission.
...
2. **PAL Detects**: It sees the "I learned" and identifies it as potential LifeOS data.
...
**Previous:** [04 — Note-Taking](./04-note-taking.md) | **Next:** [06 — PAL Builder](./06-pal-builder.md)
