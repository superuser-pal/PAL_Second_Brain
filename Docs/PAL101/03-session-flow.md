...
1. **Fire up Claude Code**: PAL automatically recognizes you (via the `SessionStart` hook).
2. **Load your Agent**: If you’re working in a specific domain, load the specialist (e.g., `/lifeOS`).
...
You don’t have to do anything. PAL already knows who you are and how you like to work from the second you start.
...
- **The Braindump**: "I’ve been thinking about this new feature..." PAL captures the notes and organizes them for me.
- **The Structured Session**: "What’s next on the Website Redesign project?" PAL looks at the project file and gives me the next three tasks.
...
**Previous:** [02 — Domains & Projects](./02-domains-and-projects.md) | **Next:** [04 — Note-Taking](./04-note-taking.md)
