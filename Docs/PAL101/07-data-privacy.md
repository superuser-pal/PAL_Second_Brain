...
When you’re chatting with PAL, Anthropic receives:
...
## PAL’s Built-in Safety

I’ve built a few "guardrails" into PAL that run automatically to help protect you:

- **Key Blocking**: If PAL sees you’re about to accidentally write something that looks like an API key or password to a file, it will block it.
- **Sensitive Folder Block**: By default, PAL won't look into your `.ssh` or system directories.
- **Environment References**: PAL is trained to use `process.env.KEY` rather than hard-coding secrets into your code files.
...
**Previous:** [06 — PAL Builder](./06-pal-builder.md) | **Next:** [08 — Cheatsheet](./08-cheatsheet.md)
