...
- [ ] Check TECHSTACKPREFERENCES.md for relevant constraints
...
- [ ] Follow best practices for my tech stack (reference TECHSTACKPREFERENCES.md)
...
- [ ] Check against TECHSTACKPREFERENCES.md
...
- [ ] Expose sensitive data from INVENTORY.md
...
- [ ] Load LOGIC_MAP.md definitions
- [ ] Initialize with TECHSTACKPREFERENCES.md
...
- [ ] Show active skills
- [ ] Summarize TECHSTACKPREFERENCES.md key points
- [ ] List recent LOGIC_MAP.md entries
- [ ] Show any session-specific context

### User-Driven Learning

**LOGIC_MAP.md updates:**
...
2. `[Reference similar past work (if any) / Check LOGIC_MAP.md for context / Use Plan-First]`

### Tech Stack Changes

**If I mention new tools/technologies:**

- [ ] Ask if I want to update TECHSTACKPREFERENCES.md
- [ ] Adjust recommendations immediately
- [ ] Add to LOGIC_MAP.md if new terminology
