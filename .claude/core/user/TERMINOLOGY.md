...
- PostToolUse - Validates YAML frontmatter schema after Write/Edit operations
...
Using hooks to automate system behavior without manual intervention. SessionStart loads context, PreToolUse validates security, PostToolUse validates frontmatter schema, Stop logs activity.
