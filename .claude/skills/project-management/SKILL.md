...
Tasks use **checkbox symbols** to indicate status. The PALOpenSource version supports **dual format** - both checkbox symbols AND hashtags for maximum compatibility.

### Dual Format Support

This implementation supports both modern checkbox symbols and legacy hashtag format:

- **Checkbox symbols** (recommended): `[/]`, `[!]`, `[?]`, `[I]`, `[-]`, `[x]`
- **Hashtags** (legacy): `#in-progress`, `#blocked`, `#paused`, `#backlog`, `#not-doing`, `#done`

**Precedence rules:** When both formats are present, checkbox symbols take precedence over hashtags.
...
### Example Project Tasks (Dual Format)
...
### Inactive
- [!] Deploy to production (waiting for security review) `#blocked`
- [?] Add advanced analytics (paused until Q2) `#paused`
- [I] Internationalization support `#backlog`
- [-] Add GraphQL support (decided against) `#not-doing`
...
**Note:** The MASTER.md generated by this skill includes both checkbox symbols and hashtags for maximum compatibility.
